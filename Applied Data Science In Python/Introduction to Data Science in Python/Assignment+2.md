...
#    for x in range(0, len(cdf['STNAME'].unique())-1):
#        dict[len(scdf.loc[cdf['STNAME'].unique()[x]])] = str(cdf['STNAME'].unique()[x])
...
def answer_eight():
    ...
    querry = reg12[(reg12['POPESTIMATE2015'] > reg12['POPESTIMATE2014'])][['STNAME', 'CTYNAME']].head()
    return querry
```
